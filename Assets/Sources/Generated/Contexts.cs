...
public partial class Contexts {
    ...
    public const string MultiReactiveNameComponet = "MultiReactiveNameComponet";
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Game.CustomVector2>(
            ...
            (e, c) => ((Game.ItemIndex)c).index));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, string>(
            MultiReactiveNameComponet,
            game.GetGroup(GameMatcher.MultiReactiveNameComponet),
            (e, c) => ((MultiReactive.NameComponet)c).name));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithMultiReactiveNameComponet(this GameContext context, string name) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.MultiReactiveNameComponet)).GetEntities(name);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
